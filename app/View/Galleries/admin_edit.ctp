        ...
        <div class="row">
            ...
            <?php echo $this->Form->input('video', array('type' => 'text','class' => 'form-control form-group', 'label' => 'URL Video')); ?>
             <?php 
                    ...
                    echo $this->Form->input('image', array('type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh <div id="smallPicture"><img src="'.$this->request->data['Gallery']["image"].'" width="150px"></div>'));
            ?>
            ...
            <?php echo $this->Form->button("Sửa", array('class' => 'btn btn-primary')); ?>
