  ...
  <div class="panel-body">
	    <div class="row">
            <div class="col-sm-3 col-md-2 col-xs-2 search-form pull-left">
                <?php echo $this->Html->link('Thêm Sản Phẩm', array('controller' => 'Products', 'action' => 'admin_edit', 'admin' => true), array('class' => 'btn btn-primary')); ?>
            </div>
            <div class="col-sm-2 col-md-2 col-xs-2 search-form pull-left">
                <?php
                    ...
                    {
                        $filter[$ProdCategory["ProdCategory"]["id"]] = $ProdCategory["ProdCategory"]["name"];
                    }
        ...
        <div class="row">
        	<div class="col-sm-12 col-md-12" id="ListProducts">
            	<?php echo $this->element('Products/admin_index'); ?>
            </div>
		</div>
