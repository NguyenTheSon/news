...
<div class="panel panel-info">
  <div class="panel-heading">
	<h3 class="panel-title">Quản lý Lịch làm tóc</h3>
  </div>
	    ...
	    <div class="row">
            ...
            <div class="col-sm-2 col-md-2 col-xs-2 search-form pull-left">
                ...
                echo $this->Form->select('filter_by_date',
                    ...
                    array(
                        'default' => $this->Session->read('Setup.filter'),
                        'class' => 'form-control',
                        'id' => 'FilterByDate',
                        'empty' => false,
                        'onchange' => 'customize()'
            ...
            <div class="col-sm-4 col-md-4 col-xs-4 search-form pull-left">
                ...
                <div class="row" id="hidden-input" style="display:none;">
                    <div class="input-group">
                        <input class="form-control" type="date" onchange="filter_submit()" id="begin_date" value="<?php echo $this->Session->read('Setup.begin_date') ?>">
                        <span class="input-group-addon">To</span>
                        <input class="form-control" type="date" onchange="filter_submit()" id="end_date" value="<?php echo $this->Session->read('Setup.end_date') ?>">
                    </div>
                </div>
            </div>

            <div class="col-sm-3 col-md-3 col-xs-5 search-form pull-right">
                <?php echo $this->Form->create('Setup', array('action'=>'index','id'=>'searchFormProduct'));?>
                    <div class="input-group">
                        <?php echo $this->Form->input('keyword', array('label' => '', 'class' => 'form-control input-sm', 'placeholder' => 'Tìm kiếm', 'value' => $this->Session->read('Setup.filter_keyword'))); ?>
