<div class="container-fluid">
          <div class="the-box">
            <label>Biểu đồ người sử dụng theo tuần</label><br>
            ...
            <div><br><br></div>
            <label>Biểu đồ người sử dụng theo tháng</label><br>
            ...
            <div><br><br></div>
            <label>Biểu đồ người sử dụng theo năm</label><br>
...
/////////////////////////////////////////////
  $("#chartweek").change(function(event) {
   var value = $(this).val();
     $.ajax({
       url: '<?php echo Router::url(array("controller" => "Statistics", "action" => "admin_user_chart")); ?>',
       type: 'POST',
       dataType: 'json',
