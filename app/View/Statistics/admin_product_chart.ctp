<div class="container-fluid">
          <div class="the-box">
            <label>Biểu đồ sản phẩm theo tuần</label><br>
            ...
            <div><br><br></div>
            <label>Biểu đồ sản phẩm theo tháng</label><br>
            ...
            <div><br><br></div>
            <label>Biểu đồ sản phẩm theo năm</label><br>
...
/////////////////////////////////////////////
  $("#chartweek").change(function(event) {
   var value = $(this).val();
     $.ajax({
       url: '<?php echo Router::url(array("controller" => "Statistics", "action" => "admin_product_chart")); ?>',
       type: 'POST',
       dataType: 'json',
