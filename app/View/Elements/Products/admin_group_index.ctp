		...
		<table class="table table-striped table-bordered table-hover table-fixed">
			...
			<tr>
				...
				<td class="actions">
					...
					<?php echo $this->Html->link('Xoá', array('action' => 'admin_del', $Product['Product']['id']), array('class' => 'btn btn-default btn-xs'),__("Bạn có chắc chắn muốn xóa nhóm sản phẩm: ".$ProdCategory['ProdCategory']['name'])); ?>
				</td>
			</tr>
			<?php endforeach; ?>
		</table>
