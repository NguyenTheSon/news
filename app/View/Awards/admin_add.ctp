		...
		<div class="col-sm-12">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"> <i class="glyphicon glyphicon-tasks"></i> Thêm Award</h3>
				</div>
					...
					<div class="control-group">
						...
						<div class="col-sm-9">
							<div style="padding-bottom: 15px;">
								<?php echo $this->Form->input('ImgAvatar', array('type' => 'text','class' => 'form-control form-group', 'label' => '<div id="smallPicture"><img src="" width="150px"></div>', 'value' => '', 'required' => 'required'));
								?>
						...
						<div class="col-sm-9">
							<div class="controls" style="padding:15px 0;">
								...
								<div id="imgs" style="padding-top: 15px;">
									Link ảnh: <input type="text" id="images[0]" name="images[0]" value="" required>
									<input type="button" value="Chọn ảnh" onclick="choose('images[0]');" />
									<br/>
								</div>
							</div>
						</div>
