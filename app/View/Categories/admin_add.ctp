  ...
  <div class="panel-body category">
    <div class="row">
      <div class="col-sm-12 col-md-6">
        ...
        <?php 
        echo $this->Form->input('images[]', array('id' => 'ismallPicture0', 'name' => 'data[Category][images][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh PC 1 <div id="smallPicture0"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <?php 
        echo $this->Form->input('images[]', array('id' => 'ismallPicture1', 'name' => 'data[Category][images][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh PC 2 <div id="smallPicture1"><img src="" width="150px"></div>', 'value' =>""));
        ?>
        ...
        echo $this->Form->input('images[]', array('id' => 'ismallPicture2', 'name' => 'data[Category][images][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh PC 3 <div id="smallPicture2"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <?php
        echo $this->Form->input('images_mobile[]', array('id' => 'ismallPicture3', 'name' => 'data[Category][images_mobile][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh Mobile 1 <div id="smallPicture3"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <?php
        echo $this->Form->input('images_mobile[]', array('id' => 'ismallPicture4', 'name' => 'data[Category][images_mobile][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh Mobile 2 <div id="smallPicture4"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <?php 
        echo $this->Form->input('images_mobile[]', array('id' => 'ismallPicture5', 'name' => 'data[Category][images_mobile][]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh Mobile 3 <div id="smallPicture5"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <?php echo $this->Form->input('images_popup', array('id' => 'ismallPicture6', 'name' => 'data[Category][images_popup]', 'type' => 'text','class' => 'form-control form-group', 'label' => 'Hình ảnh Popup <div id="smallPicture6"><img src="" width="150px"></div>', 'value' => ""));
        ?>
        ...
        <a href="<?php echo $_SERVER['HTTP_REFERER'];?>" class="btn btn-info">Quay lại</a>
