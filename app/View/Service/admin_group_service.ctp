...
<div class="panel panel-info">
  <div class="panel-heading">
	<h3 class="panel-title">Quản lý Nhóm Dịch Vụ</h3>
  </div>
  <div class="panel-body">
	    <div class="row">

            <div class="col-sm-3 col-md-2 col-xs-2 search-form pull-left">
                <?php echo $this->Html->link('Thêm Nhóm dịch vụ', array('controller' => 'Service', 'action' => 'admin_edit_group', 'admin' => true), array('class' => 'btn btn-primary')); ?>
            </div>
        ...
        <div class="row">
        	<div class="col-sm-12 col-md-12" id="ListProducts">
            	<?php echo $this->element('Service/admin_group_service'); ?>
            </div>
		</div>
