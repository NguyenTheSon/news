  ...
  <div class="panel-body">
	    <div class="row">
            ...
            <div class="col-sm-3 col-md-2 col-xs-2 search-form pull-left">
                <?php echo $this->Html->link('Thêm dịch vụ', array('controller' => 'Service', 'action' => 'admin_edit', 'admin' => true), array('class' => 'btn btn-primary')); ?>
            </div>
        ...
        <div class="row">
        	<div class="col-sm-12 col-md-12" id="ListProducts">
            	<?php echo $this->element('Service/admin_index'); ?>
            </div>
		</div>
