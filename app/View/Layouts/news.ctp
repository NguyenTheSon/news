...
<head>
  ...
  <?php echo $this->Html->css(array(
    ...
    '../news/css/prism.css',
    '../news/css/calendar-style.css',
    '../news/css/pignose.calendar.css'
    ));
    ?>
    <?php echo $this->Html->script(array(
      ...
      '../news/js/prism.min.js',
      '../news/js/moment.min.js',
      '../news/js/pignose.calendar.js',
...
<body>
  <!-- <div class="overlay hienpopup"></div> -->
  ...
  <div id="page">
    ...
    <script type="text/javascript">
      $('.close_btn').click(function () {
        $('.overlay').removeClass('hienpopup');
        $('#page .img-popup').attr('hidden' , 'hidden');
        return false;
      });
    </script>
  </div>
